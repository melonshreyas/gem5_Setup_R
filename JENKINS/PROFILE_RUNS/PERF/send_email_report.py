#!/usr/bin/env python3
"""Send the generated PERF history HTML report by email as an attachment."""
...
def send_history_report_email(
    ...
    message["From"] = sender_email or "perf-report@example.com"
    message["To"] = ", ".join(recipients)
    message.set_content("See the attached gem5 PERF history report.")
...
def parse_args() -> argparse.Namespace:
    ...
    """
    parser = argparse.ArgumentParser(description="Send a generated PERF HTML report by email.")
    parser.add_argument(
        "report_path",
        nargs="?",
        default="jenkins_history_perf_results.html",
    ...
    parser.add_argument("--subject", default="gem5 PERF Report", help="Email subject.")
